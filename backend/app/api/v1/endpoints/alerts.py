"""
Compatibility shim: expose the clean alerts router from alerts_clean.
This keeps imports stable while the original file was corrupted.
"""

from .alerts_clean import *
